...
public class NcpUtil {
    ...
    public static Object getSummary(String ncpId, String ncpSecret, String content) {
        JSONParser jsonParser = new JSONParser();
        JSONObject returnObject = null;
        ...
        try {
            ...
            documentObject.put("content", content);

            optionObject.put("language", "ko");
            optionObject.put("model", "general");
            optionObject.put("tone", 2);
            optionObject.put("summaryCount", 3);
